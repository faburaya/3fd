...
void ::UnitTestsApp_WinRT::MainPage::InitializeComponent()
{
    if (_contentLoaded)
        return;
...
void ::UnitTestsApp_WinRT::MainPage::Connect(int connectionId, Platform::Object^ target)
{
    ...
    case 1:
        (safe_cast<::Windows::UI::Xaml::Controls::Primitives::ButtonBase^>(target))->Click +=
            ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::UnitTestsApp_WinRT::MainPage::*)(Platform::Object^, Windows::UI::Xaml::RoutedEventArgs^))&MainPage::OnClickRunButton);
        break;
    }
