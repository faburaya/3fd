...
typedef HRESULT (CALLBACK* CalcBindingSSL_MultiplicationCallback) (
    _In_ const WS_OPERATION_CONTEXT* _context,
    _In_ double first, 
    _In_ double second, 
    _Out_ double* result, 
...
typedef struct CalcBindingSSLFunctionTable 
{
    ...
    CalcBindingSSL_MultiplicationCallback CalcBindingSSL_Multiplication;
...
typedef HRESULT (CALLBACK* CalcBindingUnsecure_MultiplicationCallback) (
    _In_ const WS_OPERATION_CONTEXT* _context,
    _In_ double first, 
    _In_ double second, 
    _Out_ double* result, 
...
typedef struct CalcBindingUnsecureFunctionTable 
{
    ...
    CalcBindingUnsecure_MultiplicationCallback CalcBindingUnsecure_Multiplication;
...
typedef struct _calculator_wsdl
{
    ...
    struct // policies
    {
        ...
        // port name: CalculatorEndpoint1, binding: CalcBindingSSL, namespace: http://calculator.example.org/
        WS_HTTP_SSL_POLICY_DESCRIPTION CalcBindingSSL;
        // policy for binding: CalcBindingUnsecure
        // port name: CalculatorEndpoint2, binding: CalcBindingUnsecure, namespace: http://calculator.example.org/
