...
::Windows::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider::CreateXamlType(::Platform::String^ typeName)
{
    ...
    if (typeName == L"IntegrationTestsApp_WinRT.MainPage")
    {
        ...
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::IntegrationTestsApp_WinRT::MainPage(); 
            };
    ...
    if (typeName == L"IntegrationTestsApp_WinRT.Common.NavigationHelper")
    {
    ...
    if (typeName == L"IntegrationTestsApp_WinRT.Common.RelayCommand")
    {
        ::XamlTypeInfo::InfoProvider::XamlUserType^ userType = ref new ::XamlTypeInfo::InfoProvider::XamlUserType(this, typeName, GetXamlTypeByName(L"Object"));
        userType->KindOfType = ::Windows::UI::Xaml::Interop::TypeKind::Custom;
        userType->SetIsReturnTypeStub();
...
{
    if (longMemberName == L"IntegrationTestsApp_WinRT.MainPage.NavigationHelper")
    {
        ::XamlTypeInfo::InfoProvider::XamlMember^ xamlMember = ref new ::XamlTypeInfo::InfoProvider::XamlMember(this, L"NavigationHelper", L"IntegrationTestsApp_WinRT.Common.NavigationHelper");
        xamlMember->Getter =
            [](Object^ instance) -> Object^
            {
                auto that = (::IntegrationTestsApp_WinRT::MainPage^)instance;
    ...
    if (longMemberName == L"IntegrationTestsApp_WinRT.MainPage.DefaultViewModel")
    {
    ...
    if (longMemberName == L"IntegrationTestsApp_WinRT.Common.NavigationHelper.GoForwardCommand")
    {
        ::XamlTypeInfo::InfoProvider::XamlMember^ xamlMember = ref new ::XamlTypeInfo::InfoProvider::XamlMember(this, L"GoForwardCommand", L"IntegrationTestsApp_WinRT.Common.RelayCommand");
        xamlMember->Getter =
            [](Object^ instance) -> Object^
            {
                auto that = (::IntegrationTestsApp_WinRT::Common::NavigationHelper^)instance;
    ...
    if (longMemberName == L"IntegrationTestsApp_WinRT.Common.NavigationHelper.GoBackCommand")
    {
        ::XamlTypeInfo::InfoProvider::XamlMember^ xamlMember = ref new ::XamlTypeInfo::InfoProvider::XamlMember(this, L"GoBackCommand", L"IntegrationTestsApp_WinRT.Common.RelayCommand");
        xamlMember->Getter =
            [](Object^ instance) -> Object^
            {
                auto that = (::IntegrationTestsApp_WinRT::Common::NavigationHelper^)instance;
