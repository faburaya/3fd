...
void ::IntegrationTestsApp_WinRT::MainPage::InitializeComponent()
{
    if (_contentLoaded)
        return;
...
void ::IntegrationTestsApp_WinRT::MainPage::Connect(int connectionId, Platform::Object^ target)
{
    switch (connectionId)
    {
    case 1:
        (safe_cast<::Windows::UI::Xaml::Controls::Primitives::ButtonBase^>(target))->Click +=
            ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::IntegrationTestsApp_WinRT::MainPage::*)(Platform::Object^, Windows::UI::Xaml::RoutedEventArgs^))&MainPage::OnClickRunButton);
        break;
    }
