    ...
    /* [out] */ double *result)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&AcmeTesting_StubDesc,
                  (PFORMAT_STRING) &AcmeTesting__MIDL_ProcFormatString.Format[36],
                  IDL_handle,
                  left,
                  right,
                  result);
    ...
    /* [size_is][string][out] */ unsigned char *output)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&AcmeTesting_StubDesc,
                  (PFORMAT_STRING) &AcmeTesting__MIDL_ProcFormatString.Format[84],
                  IDL_handle,
                  input,
                  output);
    ...
    /* [in] */ handle_t IDL_handle)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&AcmeTesting_StubDesc,
                  (PFORMAT_STRING) &AcmeTesting__MIDL_ProcFormatString.Format[126],
                  IDL_handle);
    ...
    /* [in] */ handle_t IDL_handle)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&AcmeTesting_StubDesc,
                  (PFORMAT_STRING) &AcmeTesting__MIDL_ProcFormatString.Format[156],
                  IDL_handle);
